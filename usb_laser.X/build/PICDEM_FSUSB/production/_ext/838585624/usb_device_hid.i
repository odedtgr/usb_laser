# 1 "../../../../../../framework/usb/src/usb_device_hid.c"
# 1 "<built-in>" 1
# 1 "<built-in>" 3
# 288 "<built-in>" 3
# 1 "<command line>" 1
...
# 2 "<built-in>" 2
# 1 "../../../../../../framework/usb/src/usb_device_hid.c" 2
# 44 "../../../../../../framework/usb/src/usb_device_hid.c"
...
# 44 "../../../../../../framework/usb/src/usb_device_hid.c" 2
...
# 45 "../../../../../../framework/usb/src/usb_device_hid.c" 2
...
# 46 "../../../../../../framework/usb/src/usb_device_hid.c" 2
# 67 "../../../../../../framework/usb/src/usb_device_hid.c"
typedef struct
{
    unsigned :8;
    unsigned :8;
...
# 161 "../../../../../../framework/usb/src/usb_device_hid.c"
void USBCheckHIDRequest(void)
{
    ...
    if(SetupPkt.bRequest == 6)
    {
        switch(SetupPkt.bDescriptorType)
        {
            ...
            case 0x22:
                ...
                {
                    { inPipes[0].pSrc.bRom = (const uint8_t*)&hid_rpt01; inPipes[0].wCount.Val = 29; inPipes[0].info.Val = 0x40 | 0x80 | 0x00; };
                ...
                break;
            case 0x23:
# 205 "../../../../../../framework/usb/src/usb_device_hid.c"
                break;
        }
    }

    if(SetupPkt.RequestType != (0x20>>5))
    {
        return;
    }
    ...
    switch(SetupPkt.bRequest)
    {
        ...
        case 0x09:
            ...
            break;
        case 0x02:
            { inPipes[0].pSrc.bRam = (uint8_t*)&idle_rate; inPipes[0].wCount.Val = 1; inPipes[0].info.Val = 0x40 | 0x80 | 0x01; };
