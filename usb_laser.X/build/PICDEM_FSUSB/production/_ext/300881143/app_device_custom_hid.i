# 1 "../demo_src/app_device_custom_hid.c"
# 1 "<built-in>" 1
# 1 "<built-in>" 3
# 288 "<built-in>" 3
# 1 "<command line>" 1
...
# 2 "<built-in>" 2
# 1 "../demo_src/app_device_custom_hid.c" 2
# 21 "../demo_src/app_device_custom_hid.c"
# 1 "../../../../../../framework/usb/inc\\usb.h" 1
# 45 "../../../../../../framework/usb/inc\\usb.h"
# 1 "../demo_src\\usb_config.h" 1
# 27 "../demo_src\\usb_config.h"
# 1 "../../../../../../framework/usb/inc\\usb_ch9.h" 1
# 42 "../../../../../../framework/usb/inc\\usb_ch9.h"
...
# 42 "../../../../../../framework/usb/inc\\usb_ch9.h" 2
...
# 6 "C:\\Program Files\\Microchip\\xc8\\v2.36\\pic\\include\\c99\\limits.h" 2 3
...
# 33 "../../../../../../framework/usb/inc/usb_hal_pic18.h"
...
# 33 "../../../../../../framework/usb/inc/usb_hal_pic18.h" 2
# 48 "../../../../../../framework/usb/inc/usb_hal_pic18.h"
...
# 48 "../../../../../../framework/usb/inc/usb_hal_pic18.h" 2
...
# 21 "../demo_src/app_device_custom_hid.c" 2

# 1 "../../../../../../framework/usb/inc\\usb_device_hid.h" 1
# 98 "../../../../../../framework/usb/inc\\usb_device_hid.h"
void USBCheckHIDRequest(void);
# 280 "../../../../../../framework/usb/inc\\usb_device_hid.h"
...
# 22 "../demo_src/app_device_custom_hid.c" 2
...
# 1 ".\\system.h" 1
# 26 ".\\system.h"
# 1 "../../../../../../bsp/picdem_fs_usb\\buttons.h" 1
...
# 54 "../../../../../../bsp/picdem_fs_usb\\buttons.h"
_Bool BUTTON_IsPressed(BUTTON button);
# 72 "../../../../../../bsp/picdem_fs_usb\\buttons.h"
void BUTTON_Enable(BUTTON button);
# 26 ".\\system.h" 2

# 1 "../../../../../../bsp/picdem_fs_usb\\leds.h" 1
...
# 56 "../../../../../../bsp/picdem_fs_usb\\leds.h"
void LED_On(LED led);
# 74 "../../../../../../bsp/picdem_fs_usb\\leds.h"
void LED_Off(LED led);
# 92 "../../../../../../bsp/picdem_fs_usb\\leds.h"
void LED_Toggle(LED led);
# 110 "../../../../../../bsp/picdem_fs_usb\\leds.h"
_Bool LED_Get(LED led);
# 127 "../../../../../../bsp/picdem_fs_usb\\leds.h"
...
# 26 "../demo_src/app_device_custom_hid.c" 2
# 44 "../demo_src/app_device_custom_hid.c"
        unsigned char ReceivedDataBuffer[64] __attribute__((address(0x500)));
        unsigned char ToSendDataBuffer[64] __attribute__((address(0x540)));
...
# 76 "../demo_src/app_device_custom_hid.c"
...
# 103 "../demo_src/app_device_custom_hid.c"
